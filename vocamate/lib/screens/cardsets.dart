...
class CardSets extends State<CardSetsPage> {
  ...
  late Future<List<Lessons>?> cardsetfuture;
  @override
  void initState(){
    super.initState();
    cardsetfuture = LessonsAPIService().getLessons();
  }
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            FutureBuilder(future: cardsetfuture, builder: (context,snapshot){
              if(snapshot.connectionState == ConnectionState.waiting){
                ...
                final cardsetlst = snapshot.data!.where((x)=>x.targetLang == "ko").toList();
                return GridView.builder(
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  itemCount: cardsetlst.length,
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => CardPage(lessonId: cardsetlst[index].id,targetlang: cardsetlst[index].targetLang,nativelang: "vi",)),
                        );
                      },
                      child: Container(
