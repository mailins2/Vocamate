...
class Home extends State<HomePage> {
  Future<Map<String,dynamic>> FetchData() async {
    DocumentSnapshot user = await FirebaseFirestore.instance
        ...
        .get();
    currentUser = user.data() as Map<String,dynamic>;
    return currentUser;
  }
      ...
      body: FutureBuilder<Map<String,dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final nativelang = displayLanguage(currentUser['nativelang']);
            final targetlang = displayLanguage(currentUser['targetlang']);
            return Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Image.asset(
                                nativelang['flag'].toString(), width: 20,
                                height: 20,),
                              SizedBox(width: 5,),
                              Text(
                                nativelang['language'].toString(),
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.white,
                                ),
                              ...
                              Image.asset(
                                targetlang['flag'].toString(), width: 20,
                                height: 20,),
                              SizedBox(width: 5,),
                              Text(
                                targetlang['language'].toString(),
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.white,
                                ),
